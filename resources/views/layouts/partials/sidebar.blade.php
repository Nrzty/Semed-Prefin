<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0">
    ...
    <nav class="mt-4 px-2 flex-1">
        <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2.5 rounded-md
            {{ request()->routeIs('dashboard') ? 'bg-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
        ...
        <a href="#" class="flex items-center px-4 py-2.5 mt-2 text-gray-600 hover:bg-gray-100 rounded-md">
            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21v-1a6 6 0 00-9-5.197" /></svg>
            <span class="ml-3">Matrícula Online</span>
        </a>
        ...
        <a href="#" class="flex items-center px-4 py-2.5 mt-2 text-gray-600 hover:bg-gray-100 rounded-md">
            ...
            <span class="ml-3">Projetos Educacionais</span>
        </a>
    </nav>
</aside>
