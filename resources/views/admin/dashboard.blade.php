        ...
        <div class="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800 mt-1">
                    R$ {{ number_format($totalCusteio + $totalCapital, 2, ',', '.') }}</p>
                <p class="text-xs text-gray-400 mt-1">Custeio: R$ {{ number_format($totalCusteio, 2, ',', '.') }} |
                    Capital: R$ {{ number_format($totalCapital, 2, ',', '.') }}</p>
            </div>
            <div class="bg-green-100 text-green-600 p-3 rounded-full">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v.01M12 18v-2m0-4v-2m0-4V4m0 0v.01M12 6v.01M12 18v.01M12 6v.01M4 6h16M4 10h16M4 14h16M4 18h16"></path>
                </svg>
            </div>
        </div>
        <div class="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800 mt-1">{{ $escolasComPrestacaoCompleta }}
                    / {{ $totalEscolas }}</p>
