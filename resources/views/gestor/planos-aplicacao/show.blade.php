<x-app-layout>
    @php
        $totalCusteio = $planos->itens->where('categoria_despesa', 'Custeio')->sum('valor_total');
        $totalCapital = $planos->itens->where('categoria_despesa', 'Capital')->sum('valor_total');
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {{-- Coluna da Direita: Painel de Ações --}}
